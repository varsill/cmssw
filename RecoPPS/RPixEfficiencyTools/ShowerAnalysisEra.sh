...
then
	...
	if true
	then	
		addJSON="useJsonFile=True jsonFileName=/afs/cern.ch/user/a/abellora/Work/CT-PPS/2018_EfficiencyTool/CMSSW_10_6_10/src/RecoCTPPS/RPixEfficiencyTools/test/JSONFiles/Run316569_Mid.json"
