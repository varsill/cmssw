...
if __name__ == '__main__':
    ...
    workflow_finite_state_machine = ctrl.FiniteStateMachine(TRANSITIONS_DICT)
    workflow_finite_state_machine.process_tasks(task_controller, TaskStatusClass=TaskStatus)
